...
class UserServiceTest {
    ...
    void testFindUserByEmail() {
        // arrange
        Mockito.when(userRepository.findByEmail("test@email.com")).thenReturn(Optional.ofNullable(user));
        ...
        Assertions.assertThrows(LostAndFoundNotFoundException.class, () -> {userService.findByEmail("gmail@gmail.com");}, "User not found");
    }
    ...
    void testInsertUser() {
        ...
        // assert
        Assertions.assertThrows(LostAndFoundValidationException.class, () -> {userService.insert(user);}, "User already exists with email id: " + user.getEmail());
    ...
    void testUpdateUser() {
        ...
        // assert
        Assertions.assertThrows(LostAndFoundNotFoundException.class, () -> {userService.update(userNotExists);}, "User does not exist.");
    ...
    void testDeleteUser() {
        ...
        // assert
        Assertions.assertThrows(LostAndFoundNotFoundException.class, () -> {userService.delete(notExistsUserEmail);}, "User does not exist.");
