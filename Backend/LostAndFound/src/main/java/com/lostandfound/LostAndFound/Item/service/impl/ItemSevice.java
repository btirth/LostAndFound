...
@Service
public class ItemSevice implements IItemService {

    private final ItemRepository itemRepository;

    ItemSevice(ItemRepository itemRepository) {
    ...
    public void update(Item item) {
        Item storedItem = this.itemRepository.findById(item.getId()).orElseThrow(() -> new IllegalStateException("student with id does not exists"));
